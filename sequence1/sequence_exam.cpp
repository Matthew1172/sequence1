...
// Modified by: Weimin Lyu- June 17, 2020
// Non-interactive test program for the sequence class from Section 3.2 of
// "Data Structures and Other Objects". Fourth Edition
//
...
// **************************************************************************
// bool test_basic(const sequence1& test, sequence1::size_type s, bool has_cursor)
...
// **************************************************************************
// bool test_items(sequence1& test, sequence1::size_type s, sequence1::size_type i, double items[])
...
// **************************************************************************
// bool correct(sequence test, sequence1::size_type s, sequence1::size_type cursor_spot, double items[])
...
// **************************************************************************
bool correct(sequence1& test, sequence1::size_type size, sequence1::size_type cursor_spot, double items[])
{
...
int test1()
{
    sequence1 empty;                            // An empty sequence
    sequence1 test;                             // A sequence to add items to
...
int test3()
{
    ...
    sequence1::size_type i;       // for-loop control variable
...
int main()
{
    ...
    cout << "If you submit your answer to Assignment 1 (Chapter 3 sequence) to us now, you will have\n";
